export const schema = {
    ...
    tags: ["production", "cryptowizards.runBacktest", "cryptowizards.checkCointegration", "cryptowizards.analyzeCopula", "cryptowizards.getCorrelations", "cryptowizards.analyzeSpread", "cryptowizards.analyzeZScores"],
    flowMCP: "1.2.0",
