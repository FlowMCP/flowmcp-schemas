    ...
    routes: {
        getFeed: {
            ...
            parameters: [
                ...
                { position: { key: "points", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "number()", options: ["optional()", "min(0)"] } },
                { position: { key: "comments", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "number()", options: ["optional()", "min(0)"] } },
                { position: { key: "count", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "number()", options: ["optional()", "min(1)", "max(100)"] } },
                ...
                { position: { key: "description", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "number()", options: ["optional()", "min(0)", "max(1)"] } },
