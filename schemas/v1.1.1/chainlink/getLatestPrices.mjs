...
import { tests } from '../../old/moralis/data/1-generate-tests-manual-eth.mjs';
...
const schema = {
    ...
    routes: {
        ...
        getAvailableFeedsForChain: {
            ...
            route: "/",
            parameters: [
                { position: { key: "chainName", value: "{{USER_PARAM}}", location: "insert" }, z: { primitive: "string()", options: ["enum(ETHEREUM_MAINNET,ARBITRUM_MAINNET,AVALANCHE_MAINNET,BASE_MAINNET,BINANCE_MAINNET,CELO_MAINNET,LINEA_MAINNET,MANTLE_MAINNET,SCROLL_MAINNET,OPTIMISM_MAINNET,POLYGON_MAINNET,ZKSYNC_MAINNET)"] } }
            ],
      ...
      getLatestPriceAribitrum: {
        ...
        getLatestPriceLinea: {
            ...
            parameters: [ 
                ...
                { position: { key: "feedName", value: "{{USER_PARAM}}", location: "insert" }, z: { primitive: "string()", options: [ "enum(ETH/USD,LINK/USD,WSTETH/USD,FOXY/USD,AAVE/USD,ARB/USD,LINK/ETH,USDC/USD,BTC/USD,EUR/USD,DAI/USD,POL/USD,USDT/USD,RSETH/ETH,MATIC/USD)" ] } }
            ],
            tests: [ { _description: "Basic test for exampleRoute", feedName: "ETH/USD" } ],
            modifiers: [ { phase: "execute", handlerName: "getLatestPrice" } ]
        },
        getLatestPriceMantle: {
            ...
            parameters: [ 
                ...
                { position: { key: "feedName", value: "{{USER_PARAM}}", location: "insert" }, z: { primitive: "string()", options: [ "enum(ETH/USD,USDC/USD,LINK/USD,BTC/USD,MNT/USD,USDT/USD)" ] } }
            ],
            tests: [ { _description: "Basic test for exampleRoute", feedName: "ETH/USD" } ],
            modifiers: [ { phase: "execute", handlerName: "getLatestPrice" } ]
        },
        getLatestPriceScroll: {
            ...
            parameters: [ 
                ...
                { position: { key: "feedName", value: "{{USER_PARAM}}", location: "insert" }, z: { primitive: "string()", options: [ "enum(WSTETH/ETH,COMP/USD,STG/USD,BNB/USD,LINK/USD,ETH/USD,SCR/USD,SOL/USD,AVAX/USD,DAI/USD,RSETH/ETH,CRV/USD,WBTC/USD,LINK/ETH,DOGE/USD,STETH/USD,BTC/USD,RETH/ETH,AAVE/USD,USDT/USD,USDC/USD,WBTC/BTC)" ] } }
            ],
            tests: [ { _description: "Basic test for exampleRoute", feedName: "ETH/USD" } ],
            modifiers: [ { phase: "execute", handlerName: "getLatestPrice" } ]
        },
        getLatestPriceZksync: {
            ...
            parameters: [ 
                ...
                { position: { key: "feedName", value: "{{USER_PARAM}}", location: "insert" }, z: { primitive: "string()", options: [ "enum(PEPE/USD,LINK/USD,LINK/ETH,AAVE/USD,USDC/USD,UNI/USD,MELANIA/USD,DAI/USD,DOGE/USD,ETH/USD,BTC/USD,ZK/USD,TRUMP/USD,USDM/USD,USDT/USD,SOL/USD)" ] } }
            ],
            tests: [ { _description: "Basic test for exampleRoute", feedName: "ETH/USD" } ],
            modifiers: [ { phase: "execute", handlerName: "getLatestPrice" } ]
        },
        getLatestPriceCelo: {
            ...
            parameters: [ 
                ...
                { position: { key: "feedName", value: "{{USER_PARAM}}", location: "insert" }, z: { primitive: "string()", options: [ "enum(CUSD/USD,BR" ] } }
            ],
            tests: [ { _description: "Basic test for exampleRoute", feedName: "ETH/USD" } ],
            modifiers: [ { phase: "execute", handlerName: "getLatestPrice" } ]
        },
