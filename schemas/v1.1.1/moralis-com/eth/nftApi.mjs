const schema = {
    ...
    'routes': {	
		...
		"/nft/:address": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get NFTs for a given contract address, including metadata for all NFTs (where available).",
		            "chain": "eth",
		...
		"/nft/:address/stats": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get the stats for a nft collection address.",
		            "chain": "eth",
		            "address": "0x306b1ea3ecdf94ab739f1910bbda052ed4a9f949"
		        }
		    ],
		...
		"/nft/:address/metadata": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get the collection / contract level metadata for a given contract.",
		            "chain": "eth",
		...
		"/nft/:address/price": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get the sold price for an NFT contract for the last x days.",
		            "chain": "eth",
		...
		"/nft/:address/transfers": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get transfers of NFTs for a given contract and other parameters.",
		            "chain": "eth",
		            "address": "0x306b1ea3ecdf94aB739F1910bbda052Ed4A9f949"
		        }
		    ],
		...
		"/nft/:address/floor-price": 		{
		    ...
		    "parameters": [
				{"position":{"key":"chain","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["enum(eth,0x1,base,0x2105)"]}},
				{"position":{"key":"address","value":"{{USER_PARAM}}","location":"insert"},"z":{"primitive":"string()","options":[]}}
			],
		    "tests": [
		        {
		            "_description": "Get floor price for a given contract.",
		            "chain": "eth",
		...
		"/nft/:address/floor-price/historical": 		{
		    ...
		    "parameters": [
				{"position":{"key":"chain","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["enum(eth,0x1,base,0x2105)"]}},
				{"position":{"key":"interval","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["enum(1d,7d,30d,60d,90d,1y,all)"]}},
				{"position":{"key":"cursor","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["optional()"]}},
				{"position":{"key":"address","value":"{{USER_PARAM}}","location":"insert"},"z":{"primitive":"string()","options":[]}}
			],
		    "tests": [
		        {
		            "_description": "Get historical floor price.",
		            "chain": "eth",
		            "interval": "1d",
		            "address": "0x524cab2ec69124574082676e6f654a18df49a048"
		        }
		...
		"/nft/:address/:token_id": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get NFT data, including metadata (where available), for the given NFT token ID and contract address.",
		            "chain": "eth",
		            "address": "0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB",
		            "token_id": "1"
		        }
		...
		"/nft/:address/owners": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get owners of NFTs for a given contract.",
		            "chain": "eth",
		            "address": "0x306b1ea3ecdf94aB739F1910bbda052Ed4A9f949"
		        }
		    ],
		...
		"/nft/:address/:token_id/price": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get the sold price for an NFT token for the last x days.",
		            "chain": "eth",
		            "address": "0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D",
		            "token_id": "1"
		        }
		...
		"/nft/:address/:token_id/owners": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get owners of a specific NFT given the contract address and token ID.",
		            "chain": "eth",
		            "address": "0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB",
		            "token_id": "1"
		        }
		...
		"/nft/:address/:token_id/trades": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get trades of NFTs for a given contract and token ID.",
		            "chain": "eth",
		            "address": "0x524cab2ec69124574082676e6f654a18df49a048",
		            "token_id": "123"
		        }
		...
		"/nft/:address/trades": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get trades of NFTs for a given contract and marketplace.",
		            "chain": "eth",
		            "address": "0x524cab2ec69124574082676e6f654a18df49a048"
		        }
		    ],
		...
		"/nft/:address/traits/paginate": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get NFT traits for a given collection",
		            "chain": "eth",
		            "address": "0x524cab2ec69124574082676e6f654a18df49a048"
		        }
		    ],
		...
		"/nft/:address/:token_id/transfers": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Get transfers of an NFT given a contract address and token ID.",
		            "chain": "eth",
		            "address": "0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB",
		            "token_id": "1"
		        }
		...
		"/nft/:address/:token_id/metadata/resync": 		{
		    ...
		    "parameters": [
				{"position":{"key":"chain","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["enum(eth,0x1,sepolia,0xaa36a7,holesky,0x4268,polygon,0x89,polygon amoy,0x13882,bsc,0x38,bsc testnet,0x61,avalanche,0xa86a,fantom,0xfa,palm,0x2a15c308d,cronos,0x19,arbitrum,0xa4b1,gnosis,0x64,gnosis testnet,0x27d8,chiliz,0x15b38,chiliz testnet,0x15b32,base,0x2105,base sepolia,0x14a34,optimism,0xa,linea,0xe708,linea sepolia,0xe705,moonbeam,0x504,moonriver,0x505,moonbase,0x507,flow,0x2eb,flow-testnet,0x221,ronin,0x7e4,ronin-testnet,0x7e5,lisk,0x46f,lisk-sepolia,0x106a)"]}},
				{"position":{"key":"flag","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["optional()","enum(uri,metadata)"]}},
				{"position":{"key":"mode","value":"{{USER_PARAM}}","location":"query"},"z":{"primitive":"string()","options":["optional()","enum(sync,async)"]}},
				{"position":{"key":"address","value":"{{USER_PARAM}}","location":"insert"},"z":{"primitive":"string()","options":[]}},
				{"position":{"key":"token_id","value":"{{USER_PARAM}}","location":"insert"},"z":{"primitive":"string()","options":[]}}
			],
		    "tests": [
		        {
		            "_description": "Resync the metadata for an NFT",
		            "chain": "eth",
		            "address": "0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB",
		            "token_id": "1"
		        }
		...
		"/nft/:address/traits/resync": 		{
		    ...
		    "tests": [
		        {
		            "_description": "Resync the NFT Trait for a given contract",
		            "chain": "eth",
		            "address": "0x524cab2ec69124574082676e6f654a18df49a048"
		        }
		    ],
