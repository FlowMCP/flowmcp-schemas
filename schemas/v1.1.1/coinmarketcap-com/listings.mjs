  ...
  routes: {
    listingsLatest: {
      ...
      parameters: [
        ...
        { position: { key: "sort", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "string()", options: ["enum(market_cap,market_cap_strict,name,symbol,date_added,price,circulating_supply,total_supply,max_supply,num_market_pairs,market_cap_by_total_supply_strict,volume_24h,percent_change_1h,percent_change_24h,percent_change_7d,volume_7d,volume_30d)", "optional()"] } },
        { position: { key: "sort_dir", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "string()", options: ["enum(asc,desc)", "optional()"] } },
        { position: { key: "cryptocurrency_type", value: "{{USER_PARAM}}", location: "query" }, z: { primitive: "string()", options: ["enum(all,coins,tokens)", "optional()"] } },
