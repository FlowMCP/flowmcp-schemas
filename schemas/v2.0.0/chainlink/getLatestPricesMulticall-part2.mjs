// Split from chainlink/getLatestPricesMulticall.mjs
// Part 2 of 2
// Migrated from v1.2.0 -> v2.0.0
// Category: handlers-imports
// Namespace: "chainlinkMulticall" -> "chainlinkmulticall"
// 13 routes (v2 max: 8) — needs splitting
// requiredLibraries: ethers
// Import: import { ethers, Interface } from 'ethers'
// Import: import { EVM_CHAINS } from '../_shared/evmChains.mjs'
// Module-level code: 4252 lines

export const main = {
    namespace: 'chainlinkmulticall',
    name: 'Multicall Latest Prices (Part 2)',
