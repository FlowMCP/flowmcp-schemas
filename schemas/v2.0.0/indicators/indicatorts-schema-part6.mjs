    ...
    return {
        getMovingMin: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getMovingMin'
        ...
        getMovingStandardDeviation: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getMovingStandardDeviation'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getMovingSum: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getMovingSum'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getNegativeVolumeIndex: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getNegativeVolumeIndex'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getNegativeVolumeIndexStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getNegativeVolumeIndexStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getOnBalanceVolume: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getOnBalanceVolume'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getParabolicSar: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getParabolicSar'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getParabolicSARStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getParabolicSARStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
