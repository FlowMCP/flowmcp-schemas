...
export const main = {
    ...
    routes: {
        getChaikinMoneyFlowStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getChaikinMoneyFlowStrategy with sample OHLCV data',
        ...
        getChaikinOscillator: {
            ...
            tests: [
                {
                    _description: 'Compute getChaikinOscillator with sample OHLCV data',
        ...
        getChandeForecastOscillator: {
            ...
            tests: [
                {
                    _description: 'Compute getChandeForecastOscillator with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
            ],
        },
        getChandeForecastOscillatorStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getChandeForecastOscillatorStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        },
        getChandelierExit: {
            ...
            tests: [
                {
                    _description: 'Compute getChandelierExit with sample OHLCV data',
                    highs: '101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121',
                    lows: '99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
        ...
        getCommunityChannelIndex: {
            ...
            tests: [
                {
                    _description: 'Compute getCommunityChannelIndex with sample OHLCV data',
                    highs: '101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121',
                    lows: '99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
        ...
        getDonchianChannel: {
            ...
            tests: [
                {
                    _description: 'Compute getDonchianChannel with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
            ],
        },
        getDoubleExponentialMovingAverage: {
            ...
            tests: [
                {
                    _description: 'Compute getDoubleExponentialMovingAverage with sample OHLCV data',
    ...
    return {
        getChaikinMoneyFlowStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getChaikinMoneyFlowStrategy'
        ...
        getChaikinOscillator: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getChaikinOscillator'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getChandeForecastOscillator: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getChandeForecastOscillator'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getChandeForecastOscillatorStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getChandeForecastOscillatorStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getChandelierExit: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getChandelierExit'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getCommunityChannelIndex: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getCommunityChannelIndex'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getDonchianChannel: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getDonchianChannel'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getDoubleExponentialMovingAverage: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getDoubleExponentialMovingAverage'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
