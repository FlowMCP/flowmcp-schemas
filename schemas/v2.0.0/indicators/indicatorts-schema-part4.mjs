...
export const main = {
    ...
    routes: {
        getEaseOfMovement: {
            ...
            tests: [
                {
                    _description: 'Compute getEaseOfMovement with sample OHLCV data',
        ...
        getEaseOfMovementStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getEaseOfMovementStrategy with sample OHLCV data',
        ...
        getExponentialMovingAverage: {
            ...
            tests: [
                {
                    _description: 'Compute getExponentialMovingAverage with sample OHLCV data',
        ...
        getForceIndex: {
            ...
            tests: [
                {
                    _description: 'Compute getForceIndex with sample OHLCV data',
        ...
        getForceIndexStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getForceIndexStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        },
        getIchimokuCloud: {
            ...
            tests: [
                {
                    _description: 'Compute getIchimokuCloud with sample OHLCV data',
                    highs: '101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121',
                    lows: '99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
        ...
        getIchimokuCloudStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getIchimokuCloudStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        },
        getKdjStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getKdjStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        }
    ...
    return {
        getEaseOfMovement: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getEaseOfMovement'
        ...
        getEaseOfMovementStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getEaseOfMovementStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getExponentialMovingAverage: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getExponentialMovingAverage'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getForceIndex: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getForceIndex'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getForceIndexStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getForceIndexStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getIchimokuCloud: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getIchimokuCloud'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getIchimokuCloudStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getIchimokuCloudStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getKdjStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getKdjStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
