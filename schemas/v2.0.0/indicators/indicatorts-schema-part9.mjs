...
export const main = {
    ...
    routes: {
        getTripleExponentialMovingAverage: {
            ...
            tests: [
                {
                    _description: 'Compute getTripleExponentialMovingAverage with sample OHLCV data',
        ...
        getTrueRange: {
            ...
            tests: [
                {
                    _description: 'Compute getTrueRange with sample OHLCV data',
        ...
        getTypicalPrice: {
            ...
            tests: [
                {
                    _description: 'Compute getTypicalPrice with sample OHLCV data',
                    highs: '101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121',
                    lows: '99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
        ...
        getTypicalPriceStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getTypicalPriceStrategy with sample OHLCV data',
        ...
        getUlcerIndex: {
            ...
            tests: [
                {
                    _description: 'Compute getUlcerIndex with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
            ],
        },
        getVolumePriceTrend: {
            ...
            tests: [
                {
                    _description: 'Compute getVolumePriceTrend with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120',
        ...
        getVolumeWeightedAveragePrice: {
            ...
            tests: [
                {
                    _description: 'Compute getVolumeWeightedAveragePrice with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120',
                    volumes: '1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400'
                }
            ],
        ...
        getVolumeWeightedAveragePriceStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getVolumeWeightedAveragePriceStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        }
    ...
    return {
        getTripleExponentialMovingAverage: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getTripleExponentialMovingAverage'
        ...
        getTrueRange: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getTrueRange'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getTypicalPrice: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getTypicalPrice'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getTypicalPriceStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getTypicalPriceStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getUlcerIndex: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getUlcerIndex'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getVolumePriceTrend: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getVolumePriceTrend'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getVolumeWeightedAveragePrice: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getVolumeWeightedAveragePrice'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getVolumeWeightedAveragePriceStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getVolumeWeightedAveragePriceStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
