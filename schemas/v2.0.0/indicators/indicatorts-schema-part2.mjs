...
export const main = {
    ...
    routes: {
        getAwesomeOscillator: {
            ...
            tests: [
                {
                    _description: 'Compute getAwesomeOscillator with sample OHLCV data',
        ...
        getAwesomeOscillatorStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getAwesomeOscillatorStrategy with sample OHLCV data',
        ...
        getBalanceOfPower: {
            ...
            tests: [
                {
                    _description: 'Compute getBalanceOfPower with sample OHLCV data',
        ...
        getBalanceOfPowerStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getBalanceOfPowerStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        },
        getBollingerBands: {
            ...
            tests: [
                {
                    _description: 'Compute getBollingerBands with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
            ],
        },
        getBollingerBandsStrategy: {
            ...
            tests: [
                {
                    _description: 'Compute getBollingerBandsStrategy with sample OHLCV data',
                    asset: '{"closings":[100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120],"highs":[101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121],"lows":[99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119],"openings":[100,101,102,102,104,105,105,107,108,108,110,111,111,113,114,114,116,117,117,119],"volumes":[1000,1200,900,1100,1300,800,1000,1400,900,1200,1100,1000,1300,1500,800,1200,1000,1100,900,1400]}'
                }
            ],
        },
        getBollingerBandsWidth: {
            ...
            tests: [
                {
                    _description: 'Compute getBollingerBandsWidth with sample OHLCV data',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120'
                }
            ],
        },
        getChaikinMoneyFlow: {
            ...
            tests: [
                {
                    _description: 'Compute getChaikinMoneyFlow with sample OHLCV data',
                    highs: '101,103,102,104,106,105,107,109,108,110,112,111,113,115,114,116,118,117,119,121',
                    lows: '99,101,100,102,104,103,105,107,106,108,110,109,111,113,112,114,116,115,117,119',
                    closings: '100,102,101,103,105,104,106,108,107,109,111,110,112,114,113,115,117,116,118,120',
    ...
    return {
        getAwesomeOscillator: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getAwesomeOscillator'
        ...
        getAwesomeOscillatorStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getAwesomeOscillatorStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getBalanceOfPower: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getBalanceOfPower'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getBalanceOfPowerStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getBalanceOfPowerStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getBollingerBands: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getBollingerBands'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getBollingerBandsStrategy: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getBollingerBandsStrategy'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getBollingerBandsWidth: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getBollingerBandsWidth'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
        ...
        getChaikinMoneyFlow: {
            executeRequest: async ( { struct, payload } ) => {
                const __routeName = 'getChaikinMoneyFlow'
                const { userParams } = payload
                const [ input, p, outputs ] = availableIndicators[ __routeName ]['validate']
