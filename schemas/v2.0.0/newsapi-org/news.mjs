            ...
            output: {
                ...
                schema: {
                    ...
                    properties: {
                        ...
                        articles: { type: 'array', items: { type: 'object', properties: { source: { type: 'object' }, author: { type: 'string' }, title: { type: 'string' }, description: { type: 'string' }, url: { type: 'string' }, urlToImage: { type: 'string' }, publishedAt: { type: 'string' }, content: { type: 'string' } } } }
                    }
                }
            },
        },
        ...
        getSources: {
            ...
            output: {
                ...
                schema: {
                    ...
                    properties: {
                        status: { type: 'string' },
                        sources: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, name: { type: 'string' }, description: { type: 'string' }, url: { type: 'string' }, category: { type: 'string' }, language: { type: 'string' }, country: { type: 'string' } } } }
                    }
                }
            },
        }
