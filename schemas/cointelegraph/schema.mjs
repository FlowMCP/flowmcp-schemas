        ...
        parameters: [
          {
            ...
            z: {
              primitive: "string",
              options: ["enum(all,editors_pick,altcoin,bitcoin,blockchain,ethereum,litecoin,monero,regulation,features,analysis,follow_up,in_depth,quiz,market_analysis,top_10_cryptocurrencies,weekly_overview)"]
            }
          },
          {
            position: {
            ...
            z: {
              primitive: "string",
              options: ["enum(1h,2h,4h,12h,24h,48h)"]
            }
          },
          {
            position: {
