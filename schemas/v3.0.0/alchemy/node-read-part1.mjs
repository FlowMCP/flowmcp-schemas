...
export const main = {
    ...
    sharedLists: [
        { ref: 'evmChains', version: '3.0.0', filter: { key: 'isTestnet', value: false } }
    ],
    ...
    tools: {
        getBlockNumber: {
            ...
            tests: [
                { _description: 'Get latest block number on Ethereum', chain: 'eth-mainnet' },
        ...
        getGasPrice: {
            ...
            tests: [
                { _description: 'Get current gas price on Ethereum', chain: 'eth-mainnet' },
        ...
        getBlock: {
            ...
            tests: [
                { _description: 'Get Ethereum block 17000000 details', chain: 'eth-mainnet', blockNumber: 17000000 }
            ],
        },
        getCode: {
            method: 'GET',
