export const main = {
    ...
    tools: {
        ...
        searchTrips: {
            ...
            description: 'Search for FlixBus/FlixTrain trips between two cities. Returns available connections with prices, departure/arrival times, duration, available seats, and transport details. City IDs can be obtained from autocompleteCities.',
            parameters: [
