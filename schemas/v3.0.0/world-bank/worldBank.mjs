export const main = {
    ...
    tools: {
        getCountryIndicator: {
            ...
            description: 'Retrieve time series data for a specific indicator and country. Returns annual values with year range support.',
            parameters: [
        ...
        listCountries: {
            method: 'GET',
            path: '/v2/country',
            description: 'List all countries and regions with metadata including income level, lending type, region, and capital city.',
            parameters: [
        ...
        listIndicators: {
            method: 'GET',
            path: '/v2/indicator',
            description: 'List World Bank indicators with descriptions, source, and topic. Supports search by source or topic.',
            parameters: [
