    ...
    tools: {
        ...
        getDepartures: {
            ...
            parameters: [
                ...
                { position: { key: 'nationalExpress', value: '{{NATIONAL_EXPRESS}}', location: 'query' }, z: { primitive: 'boolean()', options: ['optional()', 'default(true)'] } },
                { position: { key: 'regional', value: '{{REGIONAL}}', location: 'query' }, z: { primitive: 'boolean()', options: ['optional()', 'default(true)'] } }
            ],
            tests: [
        ...
        getArrivals: {
            ...
            tests: [
                ...
                { _description: 'Get arrivals at Köln Hbf', stopId: '8000207', results: 5 }
            ],
            output: {
                mimeType: 'application/json',
        ...
        planJourney: {
            method: 'GET',
            path: '/journeys',
            description: 'Plan a journey between two stations. Returns one or more journey options with legs, transfers, duration, and real-time information. Use station IDs from searchLocations.',
            parameters: [
            ...
            tests: [
                { _description: 'Plan journey Berlin to Hamburg', from: '8011160', to: '8002549', results: 2 },
                { _description: 'Plan direct journey Munich to Stuttgart', from: '8000261', to: '8000096', transfers: 0, results: 2 }
            ],
            output: {
                mimeType: 'application/json',
        ...
        getTrip: {
            ...
            parameters: [
                { position: { key: 'tripId', value: '{{TRIP_ID}}', location: 'insert' }, z: { primitive: 'string()', options: [] } }
            ],
            tests: [
